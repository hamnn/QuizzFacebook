...
// on génère la vue de la question à afficher
        $render = $this->renderView("MetinetFacebookBundle:Classement:amisPagination.html.twig", array("pagination" => $pagination));
...
//Pour chaque utilisateur on extrait l'ID correspondant
        ...
        $pagination = $paginator->paginate(
                $queryFriends, $this->get('request')->query->get('page', 1)/* page number */, 1/* limit per page */
        );
